...
export default function Footer() {
    return (
        <footer
            className="relative container bg-auto xl:bg-[length:100%] bg-center bg-no-repeat text-gray-800 dark:text-white h-80 mt-20 pt-22 m-auto border-t-2 border-gray-200"
